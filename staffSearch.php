...
<html>
    <head>
        ...
        <title>SERVE | Staff Search</title>
    </head> 
<!--Style for showing and hiding edit textbox -->
    ...
    <body>
        ...
        <form id="person-search" class="general" method="POST">
                        ...
                        if (count($persons) > 0) {
                            ...
                            foreach ($persons as $person) {
                                ...
                                echo '
                                        <tr>
                                            <td>
                                                <input type="submit" id="' . $person->get_id() . '" name="staff_id" value="' . $person->get_id() . '" style="display: none;">
            ...
            ?>
            <p>Use the form below to find a staff member.</p>
